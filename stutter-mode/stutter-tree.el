...
(minsert (cons 2 (cons 3 #'test-print)) mlist)

(minsert (cons 2 (cons 4 #'test-print)) mlist)

(minsert (cons 2 #'test-print) mlist)

(minsert (cons 3 #'test-print) mlist)

(minsert (cons 4 #'test-print) mlist)
